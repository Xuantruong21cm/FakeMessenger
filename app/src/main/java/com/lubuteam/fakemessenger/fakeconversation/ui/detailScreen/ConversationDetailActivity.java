...
import com.lubuteam.fakemessenger.fakeconversation.adapter.MessageAdapter;
import com.lubuteam.fakemessenger.fakeconversation.databinding.ActivityDetailConversationBinding;
import com.lubuteam.fakemessenger.fakeconversation.databinding.LayoutDetailBottomBinding;
import com.lubuteam.fakemessenger.fakeconversation.databinding.LayoutDetailSelectImageBinding;
import com.lubuteam.fakemessenger.fakeconversation.databinding.LayoutDetailTopBinding;
import com.lubuteam.fakemessenger.fakeconversation.dialog.DialogCreateRecord;
...
import com.lubuteam.fakemessenger.fakeconversation.dialog.DialogImageScreenshort;
import com.lubuteam.fakemessenger.fakeconversation.dialog.DialogSelectMember;
...
import com.lubuteam.fakemessenger.fakeconversation.ui.addDateTimeScreen.DateTimeActivity;
import com.lubuteam.fakemessenger.fakeconversation.ui.addMember.AddMemberActivity;
import com.lubuteam.fakemessenger.fakeconversation.ui.callScreen.CallActivity;
import com.lubuteam.fakemessenger.fakeconversation.ui.selectSticker.StickerActivity;
import com.lubuteam.fakemessenger.fakeconversation.ui.settingScreen.SettingConvesationActivity;
import com.lubuteam.fakemessenger.fakeconversation.ui.videoScreen.VideoActivity;
import com.lubuteam.fakemessenger.fakeconversation.utils.Config;
import com.lubuteam.fakemessenger.fakeconversation.utils.FileUtil;
import com.lubuteam.fakemessenger.fakeconversation.utils.ImageUtils;
import com.lubuteam.fakemessenger.fakeconversation.utils.SoftInputAssist;
...
public class ConversationDetailActivity extends BaseActivity implements IActionDetail.IView, View.OnClickListener {
    ...
    public void saveImage() {
        try {
            askPermissionStorage(() -> {
                FileUtil.createFolder(getString(R.string.app_name));
                String path = FileUtil.saveImageToGallery(ConversationDetailActivity.this
                        , FileUtil.getNewFile(ConversationDetailActivity.this, getString(R.string.app_name))
