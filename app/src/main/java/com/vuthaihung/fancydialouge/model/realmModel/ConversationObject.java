package com.vuthaihung.fancydialouge.model.realmModel;
...
//        for (int i = 0; i < this.userMessageObjects.size(); i++) {
//            for (int j = i + 1; j < userMessageObjects.size(); j++) {
//                if (userMessageObjects.get(i).equals(userMessageObjects.get(j))) {
//                    userMessageObjects.remove(j);
//                    j--;
//                }
//            }
//        }
        ...
        Log.e("userMessageModel", userMessageObjects.toString());
    }
