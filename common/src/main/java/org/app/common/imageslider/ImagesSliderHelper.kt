...
import org.app.common.imageslider.fullscreen.FullscreenImagesSliderActivity
...
class ImagesSliderHelper private constructor(builder: Builder) : LifecycleObserver {
  ...
  private fun setUpViewPagerAdapter() {
    imagesAdapter = ImagesSliderAdapter {
      if (imageClickAction != null) imageClickAction else onImageClicked(it)
    }
