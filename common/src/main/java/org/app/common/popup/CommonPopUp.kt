...
import org.app.common.databinding.PrettyPopUpBinding
import org.app.common.popup.CommonPopUp.Style.STYLE_1_HORIZONTAL_BUTTONS
import org.app.common.popup.CommonPopUp.Style.STYLE_2_VERTICAL_BUTTONS

class CommonPopUp private constructor(builder: Builder) {
  ...
  private var nativeAdView: NativeViewPreload?
  ...
  private fun setUpPopUp() {
    ...
    dialogFragment.setNativeAdView(nativeAdView)
  }
  ...
  class PrettyPopUp : DialogFragment() {
    ...
    fun setUpViews() {
      ...
      nativeAdsView?.showAds(binding.nativeAdsViewDialog)
    }
    ...
    fun setNativeAdView(view: NativeViewPreload?) {
      nativeAdsView = view
    }
  }
  ...
  class Builder(internal var fragmentManager: FragmentManager) {
    ...
    internal var nativeAdView: NativeViewPreload? = null
    ...
    fun setNativeAdView(view: NativeViewPreload?): Builder {
      this.nativeAdView = view
      return this
    }

    fun create(): CommonPopUp {
      return CommonPopUp(this)
    }
  }
}